...
- Methods/Datasets: MY-LC, INCOV, and ME/CFS proteomic datasets are candidate inputs; **GEO GSE130353** (Raijmakers2019 QFS/CFS/seropositive-control/healthy monocyte RNA-seq) is a concrete, publicly deposited cross-condition transcriptomic set usable for a pathway-level QFS↔CFS reanalysis.

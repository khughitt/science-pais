...
- Hard-endpoint reversal confirmed severity-independent (`interpretation:0005-t042-vascular-male-reversal-survives-severity-adjustment`, t042): the **male-biased** vascular/thrombotic domain (VTE, CV mortality) **survives acute-severity adjustment** — male VTE excess is present in ambulatory/non-hospitalized patients (Xie2022 adjusted HR 1.69) and within hospitalized patients (Kopp2024 CV-mortality HR 1.68), so it is a genuine domain reversal, not acute-severity carryover (the FMD/endothelial leg stays severity-confounded). Minted as `proposition:0012`. This **sharpens the measurement-channel structure**: the female excess concentrates in ascertainment-sensitive self-report channels while the reversal sits exactly where measurement is objective and ascertainment-insensitive — strengthening the self-report-vs-objective cut over a somatic-vs-neuropsychiatric one. An open mirror-image confound remains: the male vascular excess may be carried-through baseline male VTE predominance at older ages (cf. the POTS baseline-carried logic in `proposition:0009`) rather than COVID-specific amplification.

...
1. **Uninfected comparator with sex-stratified thromboembolic estimates.** In the no-prior-comorbidity
   ...
   excluding recent immigrants gives an approximate ratio-of-ratios of 1.53.
2. **Post-acute persistence overall.** In the 91-180 day window, DVT remains elevated (HR 1.20, 95% CI
   1.04-1.39) and PE remains elevated (HR 1.29, 95% CI 1.10-1.52), compared with uninfected person-time.
...
non-hospitalized/mild COVID-19 and the 31-180 day post-acute window, preferably for DVT and PE separately.
...
ambulatory sex-stratified VTE persistence remains open.
...
- Attribution: Spetz2025 supports a COVID-added male thromboembolic increment beyond pure baseline
  carryover, but the exact ambulatory 31-180 day interaction remains unresolved.

...
| **Dengue** | DHF **~230**, DF **~130** by ELISA; **but DSS ~10** by Roche ECLIA (same disease, different assay) | ELISA vs ECLIA | post-dengue fatigue **~18–32%** (2 mo–1 yr) | severity; direct IL-6→fatigue link **[UNVERIFIED]** |
...
| **Severe influenza (ICU)** | severe **~18** serum (nonsurvivors ~65); mild/outpatient **~2–4** | Luminex / ELISA | "long flu": substantial post-acute burden, **lower-magnitude than COVID**, pulmonary-weighted | severity |
...
1. **Assay heterogeneity alone breaks cross-pathogen comparability.** ELISA, Roche electrochemiluminescence (ECLIA), and Luminex/multiplex read the same sample differently by **~10–100×**; platform is unstated in most primary studies. The dengue row is the internal proof: severe dengue reads **~230 pg/mL** by ELISA but dengue *shock* reads **~10 pg/mL** by ECLIA — the assay swings the number more than the disease severity does. Any absolute cross-pathogen IL-6 ranking is therefore substantially an assay artifact, before biology is even considered.
...
- **Weakest / flagged:** per-trigger absolute pg/mL values are drawn from heterogeneous assays and, for EBV/IM, are qualitative only (**[UNVERIFIED numeric]** — primary IM studies report direction/significance, not tabulated means). Dengue and influenza IL-6 rows and the "long flu" burden are cited inline to their primary sources (Masyeni PMID 38798833; McBride PMID 38536887; Hagau PMID 21062445; Al-Aly/Xie VA cohort PMID 38104583) but were **not** added to the bib — they support table rows, not the verdict backbone.

...
- 2026-07-01 (agent, BC-7 / `interpretation:0035`): individual utilisation buildable — per-patient
  ehrQL `clinical_events`/`consultations` counts over a fixed pre-index window (near-complete for

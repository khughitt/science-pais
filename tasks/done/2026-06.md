...
Specified q0016's h0006/P4 redox-directionality gate: driver vs reciprocal-node vs downstream-marker models, provoked-muscle measurement model, admissible temporal/target-engagement evidence, and failure modes that would weaken the P4 ROS limb.
...
Authored data-gated pre-registration:0005 for the harmonized LC+ME/CFS provoked muscle-endpoint adjudicator. The rule commits same-lesion vs endpoint-contingency decision criteria for h0006, q0011/q0016, P1-P4, and h0008-M3; no belief update until a vehicle clears the serial muscle-endpoint gates.
...
Completed route triage in interpretation:0027. No public/local severity-adjusted PEM molecular matrix is runnable: STOP-PASC repo/data remains unavailable, IMPACC is not an admissible PEM-specific severity-matched vehicle on the documented phenotype surface, and RECOVER-Adult is the best controlled-access route rather than an immediate computation. Added t070 to pursue the RECOVER/dbGaP feasibility/DAR path if desired.
...
Completed vehicle hunt: no admissible non-Borrelia macrophage-reservoir or retained-burden-over-acute-load promotion vehicle found; deposited interpretation:0028; no new evidence-line coded; h0002 remains speculative.
...
Completed cross-PAIS IFN/JAK-STAT map: ingested EatonFitch2024, minted local background proposition:0036 and evidence-line:0089; deposited interpretation:0029; cross-PAIS recurrence is partial and does not discharge h0003 driver-vs-marker test.
...
Completed RECOVER-Adult q0015 controlled-access gate: phenotype side clears on public v6 release (phs003463.v6.p5; PEM/severity fields, acute covariates, EHR/wearable/biospecimen inventory), but no released/joinable omics matrix is exposed, so RECOVER remains a DAR/scoping route rather than a runnable severity-adjusted PEM molecular vehicle; deposited interpretation:0030.

## [t072] Resolve numeric-anchor validation warnings in paper notes
- priority: P2
- status: done
- aspects: []
- related: [task:t071]
- group: validation-backlog
- created: 2026-06-29
- completed: 2026-06-29

Baseline from /tmp/pais-validation-issues.json: 1993 prose_lints.numeric-anchor warnings in entities/papers across 145 files, including high-density notes such as Bramante2023 84, Fluge2019 79, Huang2024 68, Novak2026 64, Yotsuyanagi2024 63. First decide outcome of fb-2026-06-29-001: if validator gains paper-note source_refs handling, rerun and retask remaining true positives; if not, batch paper notes by warning density and add paragraph-level anchors without overstating evidence.

Upstream validator changes reduced paper-note numeric-anchor warnings from 1993 to 3; residual Goh2022/Spetz2025 source_refs and inline anchors were fixed in the first cleanup pass. Current regenerated validation has 0 numeric-anchor warnings under entities/papers.

## [t074] Resolve frontmatter-inline-gap warnings in epistemic core entities
- priority: P2
- status: done
- aspects: []
- related: [task:t071]
...
Baseline: 829 prose_lints.frontmatter-inline-gap warnings in core epistemic entities: evidence-lines 273, propositions 210, interpretations 185, questions 87, hypotheses 74. Work from highest-density files first, e.g. interpretation:0015 has 21, topic measurement artifacts 16, pre-registration:0005 has 15, hypothesis:0006 has 14, interpretation:0003 and proposition:0029/question:0011 have 13 each. For each related ref, either mention it naturally in prose, move metadata-only refs to an accepted non-prose mechanism if fb-2026-06-29-002 leads to one, or remove stale links.

Resolved upstream in the regenerated report: prose_lints.frontmatter-inline-gap is no longer present, including the core epistemic entity batch.

## [t075] Resolve frontmatter-inline-gap warnings in catalog and support entities
- priority: P3
- status: done
- aspects: []
- related: [task:t071]
...
Baseline: remaining prose_lints.frontmatter-inline-gap warnings outside the epistemic core, including papers 383/135 files, datasets 62/19, topics 59/8, pre-registrations 34/5, discussions 26/4, searches 26/8, methods 21/6, reports 17/5, plans 10/4, workflows 7/1, workflow-runs 4/1, patches 2/1, research-question 2, doc/meta 1. Apply the decision from fb-2026-06-29-002 where relevant; otherwise prune stale related refs or add concise prose references where the relation is substantively important.

Resolved upstream in the regenerated report: prose_lints.frontmatter-inline-gap is no longer present, including catalog and support entities.

## [t077] Fix small strict-validation structural and marker warnings
- priority: P2
- status: done
- aspects: []
- related: [task:t071]
...
Baseline after upstream fixes: 2 unresolved_markers aggregate warnings: 25 INACCESSIBLE-token instances and 3 SPECULATION-token instances. Earlier structural and bare-author-year warnings were fixed in the first cleanup pass. For remaining marker warnings, locate occurrences with rg, then classify each as intentionally retained, replaced with explicit prose/source detail, or converted to a task.

Completed first cleanup pass. Cleared hypothesis_comparisons, bare-author-year, unresolved_markers, and residual paper-note numeric-anchor warnings. Strict validation now reports only numeric-anchor, belief.fragile-single-line, and graph-stale warnings.

## [t073] Clean numeric-anchor warnings outside paper notes
- priority: P2
- status: done
- aspects: []
- related: [task:t071]
...
Current baseline after upstream fixes and t077 cleanup: 576 prose_lints.numeric-anchor warnings outside paper notes. Largest families: evidence-lines 239/54 files, topics 98/10, interpretations 51/18, synthesis 49/8, datasets 27/6, questions 25/7, propositions 24/11, methods 15/4, pre-registrations 14/3, reports 14/4. Batch by entity kind; for each numeric claim either add the appropriate inline citation/paragraph anchor, rewrite vague quantitative prose, or preserve as intentionally unanchored only when scientifically justified.

### Notes

- 2026-06-29: First numeric-anchor batch cleared entities/synthesis/0004-acute-severity-threshold.md: backticked entity IDs and added citations for quantitative claims. Numeric-anchor warnings dropped from 576 to 556.
- 2026-06-29: Second and third numeric-anchor batches cleared dataset/doc operational counts and high-density evidence-line source paragraphs. Added paragraph-local citations/links where claims were source-backed, corrected the Colombo dataset label to Sigera2021, added Sigera2021 and Unger2017 bibliography entries, and preserved weak/moderate evidence language. Numeric-anchor warnings dropped from 556 after the first batch to 444.
- 2026-06-29: Continued numeric-anchor cleanup across evidence-line batches 0031-0074. Added paragraph-local citations for source-backed quantitative claims, added BrandstetterFigueroa2025 BibTeX metadata from PubMed/PubMed note, and preserved weak/moderate evidence language and caveats. Numeric-anchor warnings dropped from 444 to 291; strict validation now reports 307 warnings total before graph rebuild.
- 2026-06-29: Continued numeric-anchor cleanup across interpretation, UKB/menopause method/pre-registration, and proposition batches. Added paragraph-local citations for source-backed quantitative claims, code-formatted internal field IDs/entity IDs, added Aras2025 BibTeX metadata from the sibling cycles project, and preserved existing uncertainty/evidence strength. Numeric-anchor warnings dropped from 291 to 192; strict validation now reports 208 warnings total (192 numeric-anchor, 16 belief.fragile-single-line).

Completed remaining numeric-anchor cleanup across question/report/pre-registration/topic/synthesis/evidence-line/search/plan/hypothesis batches. Strict validation now reports 0 numeric-anchor warnings and 16 remaining warnings, all belief.fragile-single-line tracked by task:t076.

## [t076] Audit fragile single-line belief warnings without weakening evidence integrity
- priority: P2
- status: done
- aspects: []
- related: [task:t071]
...
Baseline: 16 belief.fragile-single-line warnings, including propositions 0002, 0003, 0004, 0005, 0006, 0014, 0015, 0016, 0017, 0018, 0021, 0022, 0025, 0032, 0033 and hypothesis 0006. Do not clear these by relabeling weak evidence as strong or splitting dependent sources. For each warning, inspect whether genuine independent evidence exists, whether an evidence line is actually mislabeled, or whether the warning should remain with an explicit caveat/task note.

Audited all 16 belief.fragile-single-line warnings. No evidence labels were strengthened and no dependent evidence was split. Added narrow accepted_validation entries in science.yaml with per-claim reasons; strict validation now reports 0 errors, 0 warnings, 0 infos after graph rebuild.

## [t071] Coordinate strict validation backlog cleanup
- priority: P2
- status: done
- aspects: []
- group: validation-backlog
...
Umbrella task for the 2026-06-29 triage of /tmp/pais-validation-issues.json from science validate --all --strict --format json. Baseline: 4075 warnings, 0 errors. Major buckets: prose_lints.numeric-anchor 2571, prose_lints.frontmatter-inline-gap 1483, belief.fragile-single-line 16, hypothesis_comparisons 2, unresolved_markers 2 aggregate warnings, prose_lints.bare-author-year 1. Upstream feedback filed: fb-2026-06-29-001 numeric-anchor paper-note policy, fb-2026-06-29-002 frontmatter-inline-gap metadata noise, fb-2026-06-29-003 unresolved marker locations.

Strict validation backlog cleanup complete. Final strict validation report at /tmp/pais-validation-after-current.json has 0 errors, 0 warnings, 0 infos. Numeric-anchor cleanup completed in task:t073; fragile belief-line warnings audited and accepted with explicit reasons in task:t076/science.yaml.
...
- 2026-06-30: Promoted to a design-stage analysis plan: plan:0005-autoimmune-diathesis-sex-modifier-pais-analysis-plan (status not-ready). Locks TWO estimands — E1 total effect (autoimmune stratum -> PASC, NOT conditioning on acute severity, since severity is a mediator on the h0004 path) and E2 controlled-direct-effect (net of severity, distinct estimand), plus optional E3 mediation decomposition. Focal effect-modification target = sex x autoimmune-stratum interaction on BOTH additive (RERI, primary) and multiplicative scales. h0008 differential-ascertainment pre-committed as the dominant bias (individual-level utilization adjustment + negative-control outcome + population-based sampling preference). Vehicle ranking (not assumed): N3C provisional primary (Hill2022 proves the substrate; fixes pooled-Charlson + county-proxy gaps) > OpenSAFELY population-based replication (no dataset entity yet -> discovery blocker) / All-of-Us diverse replication > RECOVER-Adult phenotype adjunct > UKB baseline triangulation. Execution gated on BC-1..BC-7, tracked by new task t079. t078's decision (interpretation vs feasibility vs analysis-plan) is RESOLVED: design-stage analysis plan.

Delivered: design-stage analysis plan plan:0005 + vehicle-feasibility blocker t079. New-analysis target confirmed (not evidence extraction).
